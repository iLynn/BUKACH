...
- (void)layoutSubviews
{
    ...
    labDict[NSFontAttributeName] = self.placehoderLabel.font;
    CGSize maxSize = CGSizeMake(self.placehoderLabel.width, MAXFLOAT);
    CGRect placehoderRect = [self.placehoder boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:labDict context:nil];
